...
def gallery_convert():
    result_image_url = url_for('get_result_image')  # URL for the processed image
...
def process_video():
    ...
    try:
        ...
        return jsonify({'message': 'Video processing started', 'result_video_url': result_video_url}), 200
    except Exception as e:
